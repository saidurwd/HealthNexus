...
@section('page_title', 'IPD Settings')

@section('page_content')
<form action="{{ route('admin.ipd.settings.update') }}" method="post">
    @csrf
    @method('PUT')

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">IPD Settings</h3>
        </div>
        <div class="card-body">
        ...
        <div class="card-footer">
            <a href="{{ route('admin.ipd.dashboard') }}" class="btn btn-secondary">Cancel</a>
