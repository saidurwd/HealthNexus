...
@section('page_title', 'Laboratory Settings')

@section('page_content')
<form action="{{ route('admin.lab.settings.update') }}" method="post">
    @csrf
    @method('PUT')

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Laboratory Settings</h3>
        </div>
        <div class="card-body">
        ...
        <div class="card-footer">
            <a href="{{ route('admin.lab.dashboard') }}" class="btn btn-secondary">Cancel</a>
