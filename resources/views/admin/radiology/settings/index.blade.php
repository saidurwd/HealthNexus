...
@section('page_title', 'Radiology Settings')

@section('page_content')
<form action="{{ route('admin.radiology.settings.update') }}" method="post">
    @csrf
    @method('PUT')

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Radiology Settings</h3>
        </div>
        <div class="card-body">
        ...
        <div class="card-footer">
            <a href="{{ route('admin.radiology.dashboard') }}" class="btn btn-secondary">Cancel</a>
