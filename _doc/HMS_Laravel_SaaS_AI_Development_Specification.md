...
# 74. First AI Implementation Task

Start the project with this task:

```text
Initialize the Laravel multi-tenant SaaS HMS foundation.
...
7. Departments
8. Users
9. User-company access
10. User-branch access
11. User-department access
12. Roles
13. Permissions
14. Tenant context resolver
15. Company/branch authorization
16. Audit logging foundation
17. API /api/v1 foundation
18. Base frontend shell
19. Company/branch context selector
20. Automated tests for cross-company and cross-branch isolation

Do not implement Inventory, Laboratory, Pharmacy, Billing or Radiology yet.

The objective of this milestone is to create a secure, reusable foundation on which all future HMS modules will be built.
```

---

# 75. Architectural Decision Summary
...
Event-Driven Workflows
        +
FHIR / HL7 / DICOM Integration Layer
        +
Strict RBAC + Tenant/Branch Scope
        +
Immutable/Auditable Clinical, Stock and Financial Transactions
```

Build the **platform and tenancy foundation first**, then build clinical and operational modules on top of it.

This sequence minimizes rework and makes the resulting HMS suitable for eventual expansion from a single hospital customer to a multi-company, multi-branch SaaS platform.
