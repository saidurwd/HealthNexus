...
class IpdFloor extends Model
{
    use HasFactory, SoftDeletes;

    protected $fillable = ['company_id', 'branch_id', 'building_id', 'code', 'name', 'is_active'];
    ...
    public function wards(): HasMany { return $this->hasMany(IpdWard::class, 'floor_id'); }
